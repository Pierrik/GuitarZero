 ...
 *   $ export CLASSPATH
 *   $ javac TutorialModeController.java
 *   $ java -Djava.library.path=. TutorialModeController
 *
 *   Windows:
 ...
 *   java -Djava.library.path=. TutorialModeController
 */
public class TutorialModeController {
      ...
      if (ctrl.poll()) {
        ...
        for ( int i = 0; i < allCmps.length; i++ ) {
          ...
          if (i == WHITE1) {
            ...
            if (val == BUTTON_THRESHOLD) {
              //as the zero power is pressed, successive tutorial steps are displayed to show how the game is played.
            }
